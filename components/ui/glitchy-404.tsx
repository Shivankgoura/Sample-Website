...
const shakeVariants1 = {
  shake: {
    ...
    transition: {
      ...
      // FIX: Added 'as const' to the 'ease' property to ensure TypeScript infers a literal type, resolving framer-motion Variants type error.
...
// FIX: Changed component signature to use React.FC and removed explicit `children` from the props interface.
// This resolves a TypeScript error where the `children` prop was not being correctly inferred from JSX.
